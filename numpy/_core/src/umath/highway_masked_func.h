#ifndef _NPY_CORE_SRC_UMATH_HIGHWAY_MASKED_FUNC_H_
#define _NPY_CORE_SRC_UMATH_HIGHWAY_MASKED_FUNC_H_
...
HWY_ATTR Vec<D>
MaskedCallFunc1(D d, Vec<D> orig_x, Vec<D> transformed_x, Mask<D> mask, const Func &fallback)
{
    if (!AllTrue(d, mask)) {
        npy_uint64 maski;
